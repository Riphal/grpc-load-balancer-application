...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2a, 0x0a, 0x08, 0x53, 0x65, 0x79, 0x48, 0x65, 0x6c, 0x6c,
...
var file_chat_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatService.SeyHello:input_type -> chat.Message
	0, // 1: chat.ChatService.SeyHello:output_type -> chat.Message
...
type ChatServiceClient interface {
	SeyHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *chatServiceClient) SeyHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/chat.ChatService/SeyHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	SeyHello(context.Context, *Message) (*Message, error)
}
...
func (*UnimplementedChatServiceServer) SeyHello(context.Context, *Message) (*Message, error) {
...
func _ChatService_SeyHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).SeyHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/SeyHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).SeyHello(ctx, req.(*Message))
	}
...
var _ChatService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SeyHello",
			Handler:    _ChatService_SeyHello_Handler,
		},
	},
